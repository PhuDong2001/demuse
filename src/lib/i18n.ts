...
export const translations: Record<Language, TranslationSchema> = {
  vi: {
    ...
    heroTitle: "Quản lý thời khóa biểu, lịch làm việc & sinh hoạt.",
    heroSubtitle: "Theo dõi lịch học, ca làm việc, cuộc họp và sự kiện cá nhân. Đếm ngược thời gian và tự động phát hiện trùng giờ.",
    startFree: "Bắt đầu miễn phí",
    demoNote: "Không gian quản lý lịch trình trực quan, rõ ràng cho học tập, công việc và đời sống.",
    whatDemuseDoes: "Tính năng chính",
    whatDemuseDoesSub: "Tập trung vào những công cụ cần thiết để quản lý toàn bộ thời gian trong tuần của bạn.",
    feature1Title: "Đếm ngược thời gian thực",
    feature1Desc: "Hiển thị ca làm việc, tiết học hoặc cuộc họp sắp tới kèm địa điểm và đếm ngược thời gian còn lại.",
    feature2Title: "Phát hiện trùng lịch",
    feature2Desc: "Hệ thống tự động thông báo khi có hai lịch trình bị trùng khung giờ trên bảng tuần.",
    feature3Title: "Thông báo trên điện thoại",
    feature3Desc: "Nhắc nhở trước giờ học và giờ làm việc trên iPhone, Android và máy tính.",
    feature4Title: "Đồng bộ & Chia sẻ (.ics)",
    feature4Desc: "Nhập lịch nhanh từ Google Calendar, Apple iCal và tạo liên kết gửi bạn bè hoặc đồng nghiệp.",
    ctaTitle: "Bắt đầu sắp xếp lịch trình của bạn",
    ctaSub: "Tạo tài khoản để quản lý thời khóa biểu, ca làm việc và kế hoạch tuần dễ dàng.",
  ...
  en: {
    ...
    heroTitle: "Simple, calm schedule planner for study, work & life.",
    heroSubtitle: "Manage classes, work shifts, team meetings, and personal habits. Live countdowns, conflict alerts, and zero clutter.",
    startFree: "Get Started Free",
    demoNote: "A clean, intentional personal schedule manager for students, professionals, and creators.",
    whatDemuseDoes: "Core Features",
    whatDemuseDoesSub: "A practical tool designed to keep your weekly commitments clear, balanced, and organized.",
    feature1Title: "Live Real-Time Countdown",
    feature1Desc: "View your current and upcoming commitments with remaining time and venue information.",
    feature2Title: "Conflict Detection",
    feature2Desc: "Automatic detection and alerts when class, shift, or meeting slots overlap.",
    feature3Title: "Phone Notifications",
    feature3Desc: "Receive reminders before sessions start on mobile devices and desktop browsers.",
    feature4Title: "Calendar Sync & Sharing (.ics)",
    feature4Desc: "Import from Google Calendar, Apple iCal, or generate read-only share links for your team.",
    ctaTitle: "Organize your weekly commitments",
    ctaSub: "Create an account to start managing your courses, work shifts, and weekly schedule.",
